...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
    ...
    <title><?=config('app.name')?> Booking Request</title>
...
<h1 style="font-family:'Open Sans',sans-serif;font-size:26px;color:#ffffff;font-weight:300">Dear {{$model->name}}</h1>
...
<p><br></p>
 You can always contact us using the following details<br><p>


<b>Email address:</b> <?=$model->reply_email?><br>
<b>Telephone: </b> <?=$model->contact_telephone?>
