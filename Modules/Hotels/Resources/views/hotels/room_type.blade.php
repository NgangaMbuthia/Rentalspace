   ...
   <div class="col-md-12" >
             ...
             <div class="panel panel-white">
                <div class="panel-heading">
                  <h6 class="panel-title">Hotel Room Types</h6>
                </div>
           ...
           <script>
             $("#contact-table").dataTable({
                processing: true,
                serverSide: true,
                ajax: '<?=url("hotels/hotels/fetch_room_types")?>',
                        columns: [
                    {data: 'id', name: 'hotel_room_type.id'},
                    {data:'name',name:'hotel_room_type.name'},
                    {data:'description',name:'hotel_room_type.description'},
                    
                   {data: 'action', name: 'hotel_room_type.created_at',searchable:false},
