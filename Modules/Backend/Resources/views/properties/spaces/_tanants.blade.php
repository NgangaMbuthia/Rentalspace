...
<div class="row">
             ...
             <div class="panel panel-white">
                <div class="panel-heading">
                  <h6 class="panel-title">Tenants Who have occupied  <?=$model->number?></h6>
                </div>
           ...
           <script>
             $("#property-table").dataTable({
                processing: true,
                serverSide: true,
                ajax: '<?=url("backend/propery/fetch_space_tenants/".$id)?>',
                        columns: [
                    {data: 'id', name: 'tenants.id'},
                    {data: 'name', name: 'users.name'},
                    {data: 'number', name: 'spaces.number'},
                    {data:'created_at',name:'tenants.created_at',searchable:false},
