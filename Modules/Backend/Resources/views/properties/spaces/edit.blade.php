...
@section('content')
                 <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h6 class="panel-title"><i class="icon-home position-left"></i>Update Space Details</h6>
                                </div>
                                
                            <div class="panel-body">
                  
                    <form role="form" action="<?=url('/backend/spaces/update/'.$model->id)?>" method="post">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <?php foreach($properties as $property):?>
                                     ...
                                     <?php if($model->property->id==$property->id):?>selected <?php endif;?>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input type="text"  class="form-control"  id="category" readonly name="category" value="<?=$model->property->category->name;?>" />
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                    <label>Type</label>
                                    <input type="text"  class="form-control"  id="subcategory" readonly name="type" value="<?=$model->property->subcategory->name;?>
                                  "/>
                        ...
                        <div class="form-group col-md-6 {{ $errors->has('number') ? ' has-error' : '' }}">
                            ...
                            <input class="form-control" name="number" type="text" id="town" placeholder="Enter Space Number" autocomplete="off" value="<?=@$model->number?>">
                        ...
                        <div class="row">
                         <div class="form-group col-md-6 {{ $errors->has('location') ? ' has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title" id="location" placeholder="Enter a Name That can be used to locate this space" autocomplete="off" value="<?=@$model->title?>">
                             @if ($errors->has('title'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('title') }}</strong>
                                                </span>
                        ...
                        <div class="form-group col-md-6 {{ $errors->has('number') ? ' has-error' : '' }}">
                            ...
                            <input class="form-control" name="unit_price" type="text" id="town" placeholder="Unit Price" autocomplete="off" value="<?=@$model->unit_price?>">
                         ...
                         <div class="form-group col-md-6 {{ $errors->has('location') ? ' has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="number_of_bathrooms"  placeholder="Number of Bathrooms" value="<?=@$model->no_of_bathrooms?>">
                        ...
                        <div class="form-group col-md-6 {{ $errors->has('number') ? ' has-error' : '' }}">
                            ...
                            <input class="form-control" name="number_of_bedrooms" type="text" id="town" placeholder="Number Of BedRooms"  value="<?=@$model->no_of_bedrooms?>">
                    ...
                    <div class="col-md-12">
                        ...
                        <legend>Utility Settings</legend>
                          <div class="form-group col-md-6 {{ $errors->has('location') ? ' has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="water_meter_number"  placeholder="Water Meter Number" value="{{$model->water_meter_number}}">
                         ...
                         <div class="form-group col-md-6 {{ $errors->has('location') ? ' has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="electricity_meter_number"  placeholder="Electricity Meter Number" value="{{$model->electricity_meter_number}}">
                        ...
                        <div class="form-group">
                         ...
                         <button type="submit"  class="btn bg-teal-400 btn-labeled btn-labeled-right ml-10"><b><i class="icon-check"></i></b> Save Changes</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
   ...
   var category="<?=$model->property->category->name?>";
    if(category=="Commercial residential property" || category=="Commercial residential property"){
