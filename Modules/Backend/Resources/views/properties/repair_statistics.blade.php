   ...
   <div class="col-md-12" >
             ...
             <div class="panel panel-white">
              ...
              <div class="table-responsive">
                     ...
                     <option <?php if($mwaka==$year):?>Selected<?php endif;?>><?=$year;?></option>
                     <?php endforeach;?>
                    ...
                    <table id="repair-table" class="table table-hover table-bordered" style="width:100%;">
                        <thead>
                            <tr class="info"><th colspan="15" class="text-center">All Properties Repair Statsics For <?=$mwaka;?> </th></tr>
                            <tr class="info">
                            <th>Property</th>
                            <th>Object</th>
                  ...
                  <tr>
                    <td rowspan="2">{{$property->title}}</td>
                    <td>Number</td>
                    <?php foreach($months as $key=>$value):?>
                    <td><?=$model->statisticscount($property,$mwaka,$value)?></td>
                    <?php endforeach;?>
                    <td><?=$model->statisticscount($property,$mwaka,false)?></td>
                  </tr>

                   <tr class="warning">
                    <td>T. Cost</td>
                     <?php foreach($months as $key=>$value):?>
                    <td><i><?=number_format($model->statistics($property,$mwaka,$value),2)?></i></td>
                     <?php endforeach;?>
                     <td><i><?=number_format($model->statistics($property,$mwaka,false),2)?></i></td>
                  </tr>
                  ...
                  <?php endforeach;?>
                    ...
                    <td>T.Number</td>
                    <?php foreach($months as $key=>$value):?>
                    <td><?=$model->statisticscount(false,$mwaka,$value)?></td>
                    <?php endforeach;?>
                    <td><?=$model->statisticscount(false,$mwaka,false)?></td>
                  </tr>

                   <tr class="warning">
                    <td>T. Cost</td>
                     <?php foreach($months as $key=>$value):?>
                    <td><i><?=number_format($model->statistics(false,$mwaka,$value),2)?></i></td>
                     <?php endforeach;?>
                     <td><i><?=number_format($model->statistics(false,$mwaka,false),2)?></i></td>
                  </tr>
