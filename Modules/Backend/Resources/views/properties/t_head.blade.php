                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="<?=url('/backend/property/managers/index')?>"><span class="icon-list"></span> &nbsp;&nbsp;Caretakers</a></li>
                        <li><a href="<?=url('/backend/properties/transaction')?>"><span class="icon-list"></span> &nbsp;&nbsp;Property Transactions</a></li>

                        <li><a href="<?=url('/backend/properties/Expenses')?>"><span class="icon-list"></span> &nbsp;&nbsp;Property Expenses</a></li>
                        ...
                        <li><a href="<?=url('/backend/space/listView?status=Free')?>"><span class="icon-list"></span>  Free Spaces/Units</a></li>
                         ...
                         <li><a href="<?=url('/backend/property/import')?>">
                         <span class="icon-upload"></span>Import Properies</a></li>

                         <li><a href="<?=url('/backend/Spaces/import')?>">
                         <span class="icon-upload"></span>Import Spaces</a></li>
                    ...
                    <li class="dropdown">
                     ...
                     <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="{{url('/backend/TenantPayment/Reverse')}}">Reverse Tenant Payment</a></li>
                     ...
                     <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                          ...
                          <li><a href="{{url('/backend/Landload/MonthlyDue')}}" title="Pay Loadload">Monthly Landlord Due</a></li>
                        <li class="divider"></li>

                        <li><a href="{{url('/backend/Landload/Payments')}}">Payment History</a></li>

                         <li><a href="{{url('/backend/Landload/Reverse')}}">Reverse Transaction</a></li>
                        
                        <li><a href="{{url('/backend/Landload/Statement')}}">Statement</a></li>
                        <li><a href="{{url('/backend/Landload/Create')}}">Add Landlord</a></li>

                        <li><a href="{{url('/backend/Landload/Index')}}">Landlord Lists</a></li>

                      </ul>
                    </li>

                      <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-list"></i>Expenses<span class="caret"></span></a>
                      <ul class="dropdown-menu">
