...
<div class="row" style="margin-top:2%;">
             ...
             <div class="panel-heading">
              <h6 class="panel-title">Riverse Wrong  Tenant Payment Transactions</h6>
              <div class="heading-elements">
                <ul class="icons-list">
              ...
              <div class="col-md-12">
                ...
                <button id="Generate" style="margin-top:18%;" class="btn btn-primary btn-sm">Load Paid Units</button>
    ...
    $("#Generate").on("click",function(e){
      ...
      var start=$("#from").val();
      var to=$("#to").val();
      var url="<?=url('/backend/payment/GetPropertyPaidUnits')?>";
