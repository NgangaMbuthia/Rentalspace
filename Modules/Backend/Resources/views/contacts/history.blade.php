   ...
   <div class="col-md-12" >
             ...
             <div class="panel panel-white">
                <div class="panel-heading">
                  <h6 class="panel-title">Account Top Up History <label class="info pull-right">Current Balance :<i><?=@$balance;?></i></label></h6>
                </div>
           ...
           <script>
             $("#contact-table").dataTable({
                processing: true,
                serverSide: true,
                ajax: '<?=url("backend/contacts/topup/history")?>',
                        columns: [
                    {data: 'id', name: 'topup_histories.id'},
