...
@section('content')
<div class="row">
              <a type="submit" href="<?=url('/backend/category/management/create')?>" class="btn bg-teal-400 btn-labeled btn-labeled-right ml-10"><b><i class="icon-plus3"></i></b> Create New Category</a>
                
              </div><p></p>

             <div class="panel panel-white">
                <div class="panel-heading">
                  <h6 class="panel-title"><i class="glyphicon glyphicon-list position-left"></i>Property Categories</h6>
                </div>
            ...
            <td>
            <a href="<?=url('/backend/category/management/update/'.$category->id)?>" ><span class="glyphicon glyphicon-pencil"></span></a>
