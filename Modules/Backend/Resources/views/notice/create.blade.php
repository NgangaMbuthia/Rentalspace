 ...
 <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                     <div class="form-group {{ $errors->has('expected_end_date') ? ' has-error' : '' }}">
                                  <label> Lease End Date</label>
                                          <div class="input-group">
                                            <span class="input-group-addon"><i class="icon-calendar"></i></span>
                                            <input type="text" class="form-control" name="expected_end_date" placeholder="Lease End Date" value="{{$model->expected_end_date}}" id="datepicker" readonly />
                                        </div
  ...
  <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <div class="form-group {{ $errors->has('entry_date') ? ' has-error' : '' }}">
                      <label>Notice Report Date</label>
                                   <div class="input-group">
                                        <span class="input-group-addon"><i class="icon-calendar"></i></span>
                                           <input type="text" class="form-control datepicker" name="report_date" placeholder="Report Date" value="{{date('Y-m-d')}}"  id="datepicker2"   />
                                        </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                     <div class="form-group {{ $errors->has('expected_end_date') ? ' has-error' : '' }}">
                                  <label> Vaccation Date</label>
                                          <div class="input-group">
                                            <span class="input-group-addon"><i class="icon-calendar"></i></span>
                                            <input type="text" class="form-control" name="vacation_date" placeholder="Lease End Date" value="{{$vaccation_date}}" id="datepicker"  />
                                        </div
   ...
   <div class="col-sm-12">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div class="form-group {{ $errors->has('entry_date') ? ' has-error' : '' }}">
                      <label>Reason For Vaccating</label>
