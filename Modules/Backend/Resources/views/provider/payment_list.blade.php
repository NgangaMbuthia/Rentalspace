   ...
   <div class="col-md-12" >
             ...
             <div class="panel panel-white">
                <div class="panel-heading">
                  <h6 class="panel-title"><i class="glyphicon glyphicon-list position-left"></i>Landload Payments List</h6>
                </div>
           ...
           <script>
             $("#property-table").dataTable({
                processing: true,
                serverSide: true,
                ajax: '<?=url("backend/propery/LandloadPayments")?>',
                        columns: [
                    ...
                    {data:'method',name:'property_transactions.method'},
                    {data:'ref_no',name:'property_transactions.ref_no'},
                    {data:'Description',name:'property_transactions.Description'},
