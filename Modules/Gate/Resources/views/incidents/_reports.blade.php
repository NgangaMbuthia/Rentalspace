          ...
          <div class="col-md-12">
             ...
             <div class="panel panel-white">
                <div class="panel-heading">
                  <h6 class="panel-title">Visitor Reports</h6>
                </div>
              ...
              <div class="panel-body">
                  <div class="table-responsive">
                    ...
                    <table id="gate-visitor-report-table" class="table table-hover table-bordered" style="width:100%;">
                        <thead>
                            <tr class="info">
                            <th>ID</th>
                            <th>Name</th>
              ...
              @stop
               @push('scripts')
           <script>
             $("#gate-visitor-report-table").dataTable({
                processing: true,
                serverSide: true,
                ajax: '<?=url("security/gates/fetch_visitors_reports/".$type)?>',
                        columns: [
                    ...
                    {data:'time_in',name:'gate_visitors.time_in'},
