          ...
          <div class="col-md-12">
             ...
             <div class="panel panel-white">
                <div class="panel-heading">
                  <h6 class="panel-title">Electronics Entering and Leaving Premises</h6>
                </div>
           ...
           <script>
             $("#property-table").dataTable({
                processing: true,
                serverSide: true,
                ajax: '<?=url("security/gates/fetchvisitors/electronics")?>',
                        columns: [
                    {data: 'id', name: 'gate_electronics.id'},
                    {data: 'title', name: 'properties.title'},
                    {data:'gate_name',name:'gate_gates.name'},
                     {data:'name',name:'gate_visitors.name'},
                    
                    {data:'serial_number',name:'gate_electronics.serial_number'},
