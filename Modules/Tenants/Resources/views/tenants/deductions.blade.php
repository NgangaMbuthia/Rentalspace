...
<ol class="breadcrumb pull-left">
       ...
       <li class="active">Amount Deducted From Tenants Account</li>
</ol>
...
<div class="row">
            ...
            <div class="panel-heading">
              <h6 class="panel-title">Deductions Made on Tenants Account</h6>
              <div class="heading-elements">
                <ul class="icons-list">
  ...
  @push('scripts')
           <script>
             $("#deductions-table").dataTable({
              processing: true,
              serverSide: true,
              ajax: '<?=url("tenants/payments/fetch_credit_payments")?>',
                      columns: [
